...
| Gal(m003) = Z/2 = Weyl(SU(2)) | cusp field x²-x+1 | exact |
| Gal(m006) = S3 = Weyl(SU(3)) | cusp field x³+2x+1 | exact |
| Gal(m019) = S4 = Weyl(SU(4)) | cusp field x⁴-x-1 | exact |
...
- **m003** — SU(2) cusped parent, cusp shape e^{iπ/3}, trace field Q(√-3)
- **m006** — SU(3) cusped parent, cusp shape satisfies x³+2x+1, trace field Q(√-59)
- **m019** — SU(4) cusped parent, cusp shape satisfies x⁴-x-1, trace field Q(√-283)
...
**SnapPy note:** Always use `OrientableClosedCensus[1]` (PMNS) and `OrientableClosedCensus[43]` (CKM) by index. Do not load by name string — two distinct census manifolds share the name "m006".

## Papers

| SSRN | Title | Journal |
|---|---|---|
| [6775158](https://ssrn.com/abstract=6775158) | Unified HFG framework | PTEP/PRD |
| [6840322](https://ssrn.com/abstract=6840322) | Galois–Gauge correspondence | CNTP (pending) |
| [6840418](https://ssrn.com/abstract=6840418) | Lepton masses as BPS states on X₀(11) | LMP (submitted) |
| [6845778](https://ssrn.com/abstract=6845778) | Dual surgery / Pati-Salam | Proc. AMS (submitted) |
| [6851440](https://ssrn.com/abstract=6851440) | Delta invariant, disc=-283 | AGT (submitted) |
...
[LatticeFit v0.2.0 on PyPI](https://pypi.org/project/latticefit/) — scan hyperbolic manifold holonomy for flavor parameter fitness.
