...
foundation for applications in companion work on arithmetic
hyperbolic geometry.\footnote{The results here underpin applications
to compact hyperbolic 3-manifold holonomy; details appear separately.}
...
\bibitem{Gentry:lattice}
M.~L.~Gentry,
\newblock Discrete weight spectra and coordinate rigidity in cocompact
  hyperbolic group actions,
\newblock \emph{Ann. Global Anal. Geom.}, under review (2026).
