...
| `scans/paper8_analysis.py` | Census deduplication + SM coincidence tables | Paper 8 (NPB) |
...
- phi(b)=89.16 deg explains triple isospectrality and J_CKM≈0
...
- lambda1(m003/Meyerhoff) ~ 2.48 (leading-term estimate, Paper 8 appendix)
- lambda1(m006) ~ 2.82 (leading-term estimate, Paper 8 appendix)
