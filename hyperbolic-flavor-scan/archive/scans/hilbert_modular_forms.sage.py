...
# This file was *autogenerated* from the file hilbert_modular_forms.sage
from sage.all_cmdline import *   # import sage library

_sage_const_65 = Integer(65); _sage_const_0 = Integer(0); _sage_const_31 = Integer(31); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7); _sage_const_8 = Integer(8); _sage_const_9 = Integer(9); _sage_const_10 = Integer(10); _sage_const_11 = Integer(11); _sage_const_12 = Integer(12); _sage_const_17 = Integer(17); _sage_const_19 = Integer(19); _sage_const_3 = Integer(3); _sage_const_50 = Integer(50); _sage_const_0p01 = RealNumber('0.01'); _sage_const_45 = Integer(45); _sage_const_20 = Integer(20); _sage_const_29 = Integer(29)# hilbert_modular_forms.sage
...
# ── Lucas numbers ─────────────────────────────────────────────────────────────
L = [_sage_const_0 ]*_sage_const_31 
L[_sage_const_0 ] = _sage_const_2 ; L[_sage_const_1 ] = _sage_const_1 
for k in range(_sage_const_2 ,_sage_const_31 ):
    L[k] = L[k-_sage_const_1 ] + L[k-_sage_const_2 ]
print("Lucas numbers L_k:")
for k in [_sage_const_0 ,_sage_const_1 ,_sage_const_2 ,_sage_const_4 ,_sage_const_5 ,_sage_const_6 ,_sage_const_7 ,_sage_const_8 ,_sage_const_9 ,_sage_const_10 ,_sage_const_11 ,_sage_const_12 ,_sage_const_17 ,_sage_const_19 ]:
    print(f"  L_{k:2d} = {L[k]}")
print()
...
try:
    F = QuadraticField(_sage_const_5 , 'sqrt5')
    sqrt5 = F.gen()
    phi_F = (_sage_const_1  + sqrt5)/_sage_const_2 
    ...
    try:
        ...
        level = OF.ideal(_sage_const_3 )
        print(f"Level (3): {level}")

        HMF = HilbertModularForms(F, level, weight=_sage_const_2 )
        ...
        for p in primes(_sage_const_2 , _sage_const_50 ):
            try:
                ...
                evals = T.eigenvalues()
                for e in evals:
                    e_int = int(round(float(e))) if abs(float(e) - round(float(e))) < _sage_const_0p01  else None
        ...
        for p in primes(_sage_const_2 , _sage_const_50 ):
            if p == _sage_const_5 :
                print(f"{p:>4}  {'ram':>6}  {'RAM':>8}  {_sage_const_5 :>12}  {str(_sage_const_5  in L):>8}")
                continue
            mod5 = p % _sage_const_5 
            splits = mod5 in [_sage_const_1 ,_sage_const_4 ]  # p ≡ ±1 mod 5
            Np = p if splits else p*p
            is_lucas = Np in L[:_sage_const_20 ]
        ...
        print("-"*_sage_const_65 )
        log_phi = float(log((_sage_const_1 +sqrt(_sage_const_5 ))/_sage_const_2 ))
        for p, k in covering.items():
            Np = p if p % _sage_const_5  in [_sage_const_1 ,_sage_const_4 ] else p*p
            Lk = L[k]
            pred = float(sqrt(Np)) * Lk
            logpred = float(log(pred))/log_phi if pred > _sage_const_0  else _sage_const_0 
...
a,b = -_sage_const_2 , _sage_const_3 
...
try:
    K = QuadraticField(-_sage_const_3 , 'omega')
